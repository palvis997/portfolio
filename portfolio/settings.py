...
ALLOWED_HOSTS = list(config('ALLOWED_HOSTS', default='localhost,127.0.0.1,.onrender.com,portfolio-uocl.onrender.com', cast=Csv()))

# Automatically include Render dynamic deployment hostnames
...
CSRF_TRUSTED_ORIGINS = list(config(
    ...
    default='http://localhost:8000,http://127.0.0.1:8000,https://*.onrender.com,https://portfolio-uocl.onrender.com',
    cast=Csv()
))
